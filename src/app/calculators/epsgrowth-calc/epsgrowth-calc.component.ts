...
@Component({
  selector: 'app-epsgrowth-calc',
  templateUrl: './epsgrowth-calc.component.html',
  styleUrls: ['./epsgrowth-calc.component.scss']
})
export class EpsgrowthCalcComponent implements OnInit {
